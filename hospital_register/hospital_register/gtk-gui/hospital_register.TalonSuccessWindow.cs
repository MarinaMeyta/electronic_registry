...
{
	public partial class TalonSuccessWindow
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget hospital_register.TalonSuccessWindow
			this.Name = "hospital_register.TalonSuccessWindow";
			this.Title = global::Mono.Unix.Catalog.GetString ("TalonSuccessWindow");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Container child hospital_register.TalonSuccessWindow.Gtk.Container+ContainerChild
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString ("УСПЕШНАЯ ЗАПИСЬ");
			...
			this.label2.LabelProp = global::Mono.Unix.Catalog.GetString ("Возьмите талон");
